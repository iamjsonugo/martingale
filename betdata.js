...
document.querySelector(".process-data-btn").addEventListener("click", (event) => {
 betData();
    ...
    function calculateNextStake(previousLoss=0, resetParam=false){
      let stakeList = "300,000*50*60*75*90*110*130*160*190*230*280*340*410*490*590*710*850*1020*1220*1470*1770*2120*2550*3060*3670*4400*5280*6340*7610*9150*10980*13180*15820*18980*22780*27340*32808*39370*47240"
;
